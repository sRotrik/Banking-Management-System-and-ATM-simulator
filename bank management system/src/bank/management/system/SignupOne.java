...
public class SignupOne extends JFrame implements ActionListener {
    ...
    long random;
    JTextField nameTextField,fnameTextField,emailTextField,addressTextField,cityTextField,distTextField,stateTextField,pinTextField;
    JButton next;
        ...
        try{
            ...
            else if(pin.equals(""))
            {
               JOptionPane.showMessageDialog(null, "Pin is Required");
                ...
                Conn c=new Conn();
                String query ="insert into signup values('"+formno+"', '"+name+"', '"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+city+"', '"+dist+"', '"+state+"', '"+pin+"')";
